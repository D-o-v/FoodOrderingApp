    ...
    },
    {
      ...
      cell: (row) => (
        <select
          ...
          className="select select-bordered w-full max-w-xs my-2 text-sm"
        >
...
//             </button>
//             <div className="dropdown dropdown-end">
//               <label tabIndex={0} className="btn btn-outline btn-accent m-1">
...
//               <p className="text-lg font-semibold">Vendor Total: ₦{(selectedOrder.total - deliveryFee).toFixed(2)}</p>
//             </div>
//           </div>
//         </div>
//       )}
