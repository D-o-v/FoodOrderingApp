    ...
    <div className="container mx-auto p-2 sm:p-4 bg-gray-100 min-h-screen">
      ...
      <div className="bg-white rounded-lg shadow-md p-3 sm:p-6">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 space-y-2 sm:space-y-0">
          ...
          <div className="flex flex-wrap justify-start sm:justify-end space-x-2 w-full sm:w-auto mt-2 sm:mt-0">
        ...
        {/* Totals Section */}
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4 bg-gray-100 p-4 rounded-lg">
          <div className="stat">
            <div className="stat-title">Total Delivery Fee</div>
            <div className="stat-value text-primary">₦{totalDeliveryFee.toFixed(2)}</div>
          </div>
          <div className="stat">
            <div className="stat-title">Total Vendor Fee</div>
            <div className="stat-value text-secondary">₦{totalVendorFee.toFixed(2)}</div>
          </div>
          <div className="stat">
            <div className="stat-title">Total Orders Total</div>
            <div className="stat-value">₦{totalOrdersTotal.toFixed(2)}</div>
          </div>
        </div>
